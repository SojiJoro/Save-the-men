  ...
  return (
    <div className="intro-section">
      ...
      <p style={{ marginTop: '20px' }}>
        ...
        We host online and offline events where men can meet, share experiences, and learn from one another.
      </p>
      <h2 style={{ marginTop: '30px' }}>Upcoming Events</h2>
      <ul style={{ marginTop: '10px', lineHeight: '1.8' }}>
        <li><strong>Monthly Online Forum:</strong> Last Saturday of each month (Zoom). Topic: “Overcoming Stigma & Finding Help.”</li>
        ...
        <li><strong>In-Person Meetup (London):</strong> Social gathering to share stories and connect with local resources.</li>
      </ul>
