    ...
    return (
      <div className="intro-section">
        ...
        <p style={{ marginTop: '20px' }}>
          ...
          especially those facing domestic abuse or difficult home situations.
        </p>
        <ul style={{ marginTop: '20px', lineHeight: '1.8' }}>
          ...
          <li><strong>Advocacy & Mediation:</strong> Linking you with local advocacy groups that can guide you through legal proceedings.</li>
